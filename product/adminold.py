...
class ProductBrandAdmin(admin.ModelAdmin):
    ...
    def upload_csv(request):
        if request.method == "POST":
            ...
            # Return the progress to the frontend after processing is complete
            response_data = {
                'progress': 100,  # Indicate that processing is complete
            }
...
class CatalogCategoryAdmin(admin.ModelAdmin):
    ...
    def has_view_permission(self, request, obj=None):
        return self._has_permission(request, 'view_catalogcategory')

    def has_change_permission(self, request, obj=None):
        return self._has_permission(request, 'change_catalogcategory')

    def has_add_permission(self, request, obj=None):
        return self._has_permission(request, 'add_catalogcategory')
