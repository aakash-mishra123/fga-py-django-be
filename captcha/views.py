...
def getsize(font, text):
    """
    Get the size of the text using the appropriate method based on font capabilities.

    This function handles different versions of PIL/Pillow by checking which
    methods are available on the font object.
    """
    if hasattr(font, "getbbox"):
        top, left, right, bottom = font.getbbox(text)
